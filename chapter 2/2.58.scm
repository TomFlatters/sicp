...
; the following must be accredited to 'AMS':
...
; we have the case when we have a pair, with '**' the car
...
; the base cases are what allows us to reach some end case - therefore they are not just important but necessary
